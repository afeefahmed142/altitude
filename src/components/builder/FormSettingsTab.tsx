      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-[#e5e7eb]">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-[#3b2bee] hover:bg-[#3020d6] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer"
            >
          ...
          <div className="space-y-5 animate-in fade-in">
            <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6 shadow-2xs space-y-4">
              <h2 className="text-sm font-bold text-[#111827] flex items-center gap-2">
                <Sliders className="w-4 h-4 text-[#3b2bee]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-[#d1d5db] rounded-xl text-xs text-[#111827] bg-white focus:outline-none focus:border-[#3b2bee]"
                  >
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 border border-[#d1d5db] rounded-xl text-xs text-[#111827] focus:outline-none focus:border-[#3b2bee]"
                    />
                  </div>
                </div>
              </div>
        ...
        {activeSubSection === 'notifications' && (
          <div className="space-y-5 animate-in fade-in">
            <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6 shadow-2xs space-y-4">
              <h2 className="text-sm font-bold text-[#111827] flex items-center gap-2">
                <Mail className="w-4 h-4 text-[#3b2bee]" />
              ...
              <div className="space-y-4">
                <label className="flex items-start justify-between p-3.5 border border-[#f0f2f5] rounded-xl cursor-pointer hover:bg-[#fafbfc] transition-colors">
                  ...
                  <input
                    ...
                    className="w-4 h-4 text-[#3b2bee] rounded focus:ring-0 cursor-pointer"
                  />
                </label>

                {settings.emailNotifications && (
                  <div className="space-y-1 pl-3.5 border-l-2 border-[#3b2bee]">
        ...
        {activeSubSection === 'security' && (
          <div className="space-y-5 animate-in fade-in">
            <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6 shadow-2xs space-y-4">
              <h2 className="text-sm font-bold text-[#111827] flex items-center gap-2">
                <Shield className="w-4 h-4 text-[#3b2bee]" />
        ...
        {activeSubSection === 'theme' && (
          <div className="space-y-5 animate-in fade-in">
            <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6 shadow-2xs space-y-4">
              <h2 className="text-sm font-bold text-[#111827] flex items-center gap-2">
                <Palette className="w-4 h-4 text-[#3b2bee]" />
                      ...
                      <button
                        ...
                        className={`h-20 rounded-xl overflow-hidden relative border-2 transition-all cursor-pointer ${
                          bannerImage === preset.url
                            ? 'border-[#3b2bee] ring-2 ring-[#3b2bee]/20'
