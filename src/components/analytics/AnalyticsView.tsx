    ...
    <div id="analytics-view-container" className="flex-1 overflow-y-auto bg-[#fbfbfe] p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5 text-xs text-[#6b7280] font-mono">
              <span className="flex items-center gap-1.5 text-[#3b2bee] font-bold">
                <span className="w-2 h-2 rounded-full bg-[#3b2bee] animate-pulse" />
                LIVE COLLECTING
              </span>
              <span>•</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div
            id="ai-insights-card"
            className="lg:col-span-8 bg-gradient-to-br from-[#f5f3ff] via-[#faf8ff] to-[#f8f9ff] border border-[#ddd6fe] rounded-2xl p-6 shadow-2xs flex flex-col justify-between"
          >
            <div>
              {/* Header tag */}
          ...
          >
            ...
            <button
              ...
              className="mt-5 w-full py-2.5 bg-[#e0e7ff] hover:bg-[#c7d2fe] text-[#3730a3] text-xs font-bold rounded-xl transition-all cursor-pointer text-center"
            >
              Review & Quarantine
            </button>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-1.5">
                <span className="w-4 h-2.5 rounded-xs bg-[#c7d2fe]" />
            ...
            <div className="relative border border-[#f0f2f5] rounded-xl p-4 bg-[#fafbfc]">
              ...
              <div className="h-44 flex items-end justify-around relative z-1 gap-3 pt-4">
                ...
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                  <div className="w-full bg-[#c7d2fe] group-hover:bg-[#a5b4fc] rounded-t-md transition-all h-[35%]" />
                </div>
                {/* Bar 2: 30s light */}
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                ...
                {/* Bar 4: 1m */}
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                  <div className="w-full bg-[#6366f1] group-hover:bg-[#4f46e5] rounded-t-md transition-all h-[100%]" />
                </div>
                {/* Bar 5: 1m medium */}
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                ...
                {/* Bar 6: > 2m light */}
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                  <div className="w-full bg-[#c7d2fe] group-hover:bg-[#a5b4fc] rounded-t-md transition-all h-[45%]" />
                </div>
                {/* Bar 7: > 2m pale */}
                <div className="flex-1 flex flex-col items-center group h-full justify-end">
                  <div className="w-full bg-[#e0e7ff] group-hover:bg-[#c7d2fe] rounded-t-md transition-all h-[25%]" />
                </div>
              </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="w-full h-2.5 bg-[#f3f4f6] rounded-full overflow-hidden">
                  <div className="h-full bg-[#4f46e5] rounded-full w-[78%]" />
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative h-64 bg-[#eef2ff] rounded-xl border border-[#e0e7ff] overflow-hidden flex items-center justify-center p-4">
              ...
              <div className="absolute left-[35%] top-[30%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                <div className="w-4 h-4 rounded-full bg-[#3b2bee] animate-ping opacity-75" />
                <div className="absolute w-3 h-3 rounded-full bg-[#3b2bee] border-2 border-white shadow-xs" />
              </div>

              {/* Node 2: Europe */}
              <div className="absolute left-[48%] top-[65%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                <div className="w-2.5 h-2.5 rounded-full bg-[#3b2bee] border-2 border-white" />
              </div>

              {/* Node 3: Asia Pacific */}
              <div className="absolute right-[22%] top-[55%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                <div className="w-4 h-4 rounded-full bg-[#3b2bee] animate-ping opacity-75" />
                <div className="absolute w-3.5 h-3.5 rounded-full bg-[#3b2bee] border-2 border-white shadow-xs" />
              </div>

              {/* Center Map Icon overlay */}
              <div className="w-12 h-12 rounded-xl bg-white/80 backdrop-blur-sm border border-[#c7d2fe] text-[#3b2bee] flex items-center justify-center shadow-xs">
