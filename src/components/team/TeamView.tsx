          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {directories.map((dir) => (
              <div
                ...
                className="bg-white border border-[#e5e7eb] hover:border-[#c7d2fe] hover:shadow-xs rounded-2xl p-5 transition-all cursor-pointer group flex flex-col justify-between"
              >
                ...
                <div className="mt-4">
                  <h3 className="text-sm font-bold text-[#111827] group-hover:text-[#3b2bee] transition-colors">
                    {dir.name}
                  </h3>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#f5f3ff] text-[#7c3aed] text-[10px] font-bold tracking-wider uppercase border border-[#ddd6fe] font-mono">
            ...
            >
              <div className="flex flex-wrap items-center gap-3 text-xs font-semibold text-[#111827]">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-white border border-[#e5e7eb] rounded-xl shadow-2xs">
                  <div className="w-5 h-5 rounded-md bg-[#eef2ff] text-[#3b2bee] flex items-center justify-center">
                ...
                <div>
                  <span
                    className={`text-[10px] font-bold px-2.5 py-1 rounded-md tracking-wider uppercase font-mono ${
                      member.role === 'ADMIN'
                        ? 'bg-[#eef2ff] text-[#3b2bee] border border-[#c7d2fe]'
                        : member.role === 'EDITOR'
