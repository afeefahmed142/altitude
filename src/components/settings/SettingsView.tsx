    ...
    <div id="settings-view-root" className="flex-1 overflow-y-auto bg-[#fbfbfe] p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6 shadow-2xs space-y-5">
          <div className="flex items-center gap-2 text-sm font-bold text-[#3b2bee]">
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between p-3 border border-[#f0f2f5] rounded-xl cursor-pointer hover:bg-[#fafbfc]">
              ...
              <input
                ...
                className="w-4 h-4 text-[#3b2bee] rounded focus:ring-0"
              />
            </label>
        ...
        <div className="flex justify-end">
          <button
            onClick={handleSave}
            className="flex items-center gap-2 px-5 py-2.5 bg-[#3b2bee] hover:bg-[#3020d6] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer"
          >
