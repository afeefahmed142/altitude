    ...
    <div id="form-logic-tab-root" className="flex-1 overflow-y-auto bg-[#fbfbfe] p-6 md:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between bg-white border border-[#e5e7eb] rounded-2xl p-2 shadow-2xs">
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-[#3b2bee] text-white shadow-2xs transition-all cursor-pointer"
              >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-[#e5e7eb]">
          <div>
            <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#3b2bee] uppercase tracking-wider">
              <GitBranch className="w-3.5 h-3.5" />
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold text-[#7c3aed] bg-[#f5f3ff] hover:bg-[#ede9fe] border border-[#ddd6fe] rounded-xl transition-all cursor-pointer shadow-2xs"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#3b2bee] hover:bg-[#3020d6] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer"
            >
        ...
        {isCreatingNew && (
          <div className="bg-white border-2 border-[#3b2bee] rounded-2xl p-6 shadow-md space-y-5 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm font-bold text-[#111827]">
                <Zap className="w-4 h-4 text-[#3b2bee]" />
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#d1d5db] rounded-xl text-xs text-[#111827] focus:outline-none focus:border-[#3b2bee]"
                />
              </div>

              {/* IF Condition Box */}
              <div className="bg-[#f8f9ff] border border-[#e0e7ff] rounded-xl p-4 space-y-3">
                <div className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#3b2bee]">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#3b2bee] hover:bg-[#3020d6] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer flex items-center gap-1.5"
                >
        ...
        <div className="space-y-4">
          ...
          {rules.length === 0 ? (
            <div className="bg-white border border-[#e5e7eb] rounded-2xl p-10 text-center space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-[#eef2ff] text-[#3b2bee] flex items-center justify-center mx-auto">
              ...
              <button
                type="button"
                onClick={() => setIsCreatingNew(true)}
                className="px-4 py-2 bg-[#3b2bee] text-white text-xs font-bold rounded-xl hover:bg-[#3020d6] cursor-pointer"
              >
                ...
                >
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs text-[#374151]">
                      <span className="font-mono font-bold text-[#3b2bee] bg-[#eef2ff] px-2 py-0.5 rounded">
                        IF
                      </span>
                      ...
                      <span className="font-mono font-bold text-[#7c3aed] bg-[#f5f3ff] px-2 py-0.5 rounded uppercase">
